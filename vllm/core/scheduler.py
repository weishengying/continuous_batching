...
class Scheduler:
    ...
    def _schedule(
        ...
        while self.running:
            ...
            # (TODO weishengying)here we should determine whether the memory of GPU is sufficient
        ...
        while self.waiting:
            ...
            # (TODO we shoulud allocate cachekv memory ahead of time)
    ...
    def _allocate(self, seq_group: SequenceGroup) -> None:
        # we should allocate cachekv memory ahead of time
        for seq in seq_group.get_seqs():
